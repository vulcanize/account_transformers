...
func (tr *Transformer) Init() error {
	for contractAddr := range tr.Config.Addresses {
		...
		lastBlock, err := tr.Retriever.RetrieveMostRecentBlock()
		if err != nil {
			return err
		}
		...
		var name = new(string)
		tr.Poller.FetchContractData(tr.Parser.Abi(), contractAddr, "name", nil, name, lastBlock)
...
func (tr *Transformer) Execute() error {
	...
	for _, con := range tr.Contracts {
		...
		var err error
		con.LastBlock, err = tr.Retriever.RetrieveMostRecentBlock()
		if err != nil {
			return err
		}
		if err := tr.Poller.PollContract(*con); err != nil {
			return err
		}
	}
